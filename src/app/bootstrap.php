...
define('BACKEND_URL', 'http://mymed20.sophia.inria.fr/backend');
...
$userRole = isset($_SESSION['user'], $_SESSION['user']->id) ? (isset($_SESSION['user']->role[APP_NAME])?$_SESSION['user']->role[APP_NAME]:2) : 0;
